...
x=0;  
% We will focus on the fields in the yz plane
y=linspace(-0.5,0.5,24);  
% These definethe y and z values of the  
z=linspace(-2,2,50);  
...
title(
'
Value of Ey in the yz Plane 
for a Uniformly Charged Line 
of Length 2h'
);
grid 
on
;
figure 
% Create a figure for the view of the Ez component of the field
mesh(Y,Z,Ez);
xlabel(
'y 
-
...
title(
'
Value of Ez in the yz Plane 
for a Uniformly Charged Line of Length 2h'
);
grid 
on
;